...
configuration.',
    ...
    public function _sortChannels($a, $b)
    {
    ...
    public function doUpdateAll($command, $options, $params)
    {
        $reg = &$this->config->getRegistry();
    ...
    public function doUpdate($command, $options, $params)
    {
        if (count($params) !== 1) {
     ...
     */
    public function doDiscover($command, $options, $params)
    {
        if (count($params) !== 1) {
